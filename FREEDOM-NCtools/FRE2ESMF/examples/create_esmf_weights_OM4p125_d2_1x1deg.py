...
static_src = xr.open_dataset(f'{gridspec}/ocean_hgrid_d2.nc')
static_src2 = xr.open_dataset(f'{gridspec}/ocean_static_d2.nc')
...
static_dst = xr.open_dataset(f'{ppstatic}/ocean_annual_z_1x1deg.static.nc')
